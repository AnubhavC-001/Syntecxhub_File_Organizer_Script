...
Write-Host "=== Registering File Organizer Scheduled Task ==="

# Check if Python exists in venv
if (-not (Test-Path $PythonPath)) {
    Write-Error "Virtual environment Python interpreter not found! Please create the venv first."
    exit
}
...
Write-Host "Scheduled Task successfully registered!"
Write-Host "It is set to run Daily at 12:00 PM."
Write-Host "To showcase it running immediately, run: Start-ScheduledTask -TaskName Syntecxhub_File_Organizer"
